...
//            }
            ...
            String mapperName = tableInfo.getBeanName() + Constans.SUFFIX_MAPPERS;
            ...
            bw.newLine();
            bw.write("import " + Constans.PACKAGE_ENUMS + ".PageSize;");
            bw.newLine();
            bw.write("import " + Constans.PACKAGE_MAPPERS + "." + mapperName + ";");
            bw.newLine();
